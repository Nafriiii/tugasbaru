...
2. Lalu buka **Settings** pada repository tersebut, pilih **Collaborators**, dan masukkan username GitHub teman yang akan diajak.
...
- **Tampilan Login**  
  Yang dimana terdapat 2 field untuk menginputkan email dan password, serta terdapat button untuk login dan register.
...
- **Tampilan Database MySQL**  
  Sebagai tempat menyimpan data yang sudah dibuat sebelumnya.
